...
export class HeaderHelper {
    ...
    get openButton() { return this.header.openMenuButton; }
    get closeButton() { return this.header.closeMenuButton; }
    get allItemsLink() { return this.header.allItemsLink; }
    get aboutLink() { return this.header.aboutLink; }
    get logoutLink() { return this.header.logoutLink; }
    get resetLink() { return this.header.resetAppStateLink; }
